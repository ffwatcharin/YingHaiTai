...
# load images
tree1_img = pygame.image.load(
    'assets/img/background/level1/tree1.png').convert_alpha()
tree2_img = pygame.image.load(
    'assets/img/background/level1/tree2.png').convert_alpha()
mountain_img = pygame.image.load(
    'assets/img/background/level1/mountain.png').convert_alpha()
sky_img = pygame.image.load(
    'assets/img/background/level1/sky.png').convert_alpha()
...
def draw_bg():
    ...
    for x in range(4):
        ...
        screen.blit(mountain_img, ((x * width) - scroll * 0.6,
                    SCREEN_HEIGHT - mountain_img.get_height() - 250))
        screen.blit(tree1_img, ((x * width) - scroll * 0.7,
                    SCREEN_HEIGHT - tree1_img.get_height() - 130))
        screen.blit(tree2_img, ((x * width) - scroll * 0.8,
                    SCREEN_HEIGHT - tree2_img.get_height()))
...
load_button = button.Button(SCREEN_WIDTH // 2 + 200, SCREEN_HEIGHT + LOWER_MARGIN - 120, load_img, 1)
# make a button list
button_list = []
button_col = 0
button_row = 0
...
while run:
    ...
    draw_text('Press UP or DOWN to change level', font, WHITE, 10, SCREEN_HEIGHT + LOWER_MARGIN - 100)
    ...
    #check that the cordinates are within the tile area
